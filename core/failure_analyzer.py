...
class FailureAnalyzer:
    ...
    def _classify_failure(
        self, question: str, correct: str, predicted: str, response: str, reasoning: str
    ...
    def analyze_batch(
        self, failed_samples: list[dict[str, Any]], total_samples: int | None = None
