...
MODEL_SPEC_REGISTRY: dict[str, ModelSpec] = {
    "deepseek-v3": ModelSpec(
        name="DeepSeek-V3", family="DeepSeek", architecture="moe",
        total_params_b=671, active_params_b=37, num_experts=256, num_experts_per_tok=8,
        num_shared_experts=1, routed_scaling=2.5,
        num_layers=61, hidden_size=7168, num_attention_heads=128, num_kv_heads=128,
        attention_type="mla", vocab_size=129280,
        max_position_embeddings=128000, weight_dtype="fp8", quant_method="fp8",
        kv_dtype="fp8", supports_mtp=True, mtp_depth=1, mtp_method="DeepSeek-MTP",
    ),
    "deepseek-v3.1": ModelSpec(
        name="DeepSeek-V3.1", family="DeepSeek", architecture="moe",
        total_params_b=671, active_params_b=37, num_experts=256, num_experts_per_tok=8,
        num_shared_experts=1, num_layers=61, hidden_size=7168, num_attention_heads=128,
        attention_type="mla", vocab_size=129280, max_position_embeddings=128000,
        weight_dtype="fp8", quant_method="fp8", kv_dtype="fp8",
        supports_mtp=True, mtp_depth=1, mtp_method="DeepSeek-MTP",
    ),
    "deepseek-v3.2": ModelSpec(
        name="DeepSeek-V3.2-Exp", family="DeepSeek", architecture="moe",
        total_params_b=685, active_params_b=37, num_experts=256, num_experts_per_tok=8,
        num_shared_experts=1, num_layers=61, hidden_size=7168, num_attention_heads=128,
        attention_type="mla", max_position_embeddings=128000,
        weight_dtype="fp8", quant_method="fp8", kv_dtype="fp8",
        supports_mtp=True, mtp_depth=1, mtp_method="DeepSeek-MTP",
    ),
    "qwen3-235b": ModelSpec(
        name="Qwen3-235B-A22B", family="Qwen3", architecture="moe",
        total_params_b=235, active_params_b=22, num_experts=128, num_experts_per_tok=8,
        num_layers=94, hidden_size=5120, num_attention_heads=64, num_kv_heads=4,
        attention_type="gqa", max_position_embeddings=262144,
        weight_dtype="bf16", kv_dtype="fp16",
    ),
    "qwen3-30b": ModelSpec(
        name="Qwen3-30B-A3B", family="Qwen3", architecture="moe",
        total_params_b=30, active_params_b=3, num_experts=128, num_experts_per_tok=8,
        num_layers=48, hidden_size=2048, num_attention_heads=32, num_kv_heads=4,
        attention_type="gqa", max_position_embeddings=262144,
        weight_dtype="bf16", kv_dtype="fp16",
    ),
    "qwen2.5-72b": ModelSpec(
        name="Qwen2.5-72B", family="Qwen2.5", architecture="dense",
        total_params_b=72, active_params_b=72, num_layers=80, hidden_size=8192,
        num_attention_heads=64, num_kv_heads=8, attention_type="gqa",
    ...
    "kimi-k2": ModelSpec(
        ...
        weight_dtype="int4+bf16(mixed)", quant_method="compressed-tensors", group_size=32,
    ...
    "glm-4.5": ModelSpec(
        ...
        total_params_b=355, active_params_b=32, num_experts=256, num_experts_per_tok=32,  # 含 shared
        num_layers=61, hidden_size=7168, num_attention_heads=64, num_kv_heads=8,
        attention_type="gqa", max_position_embeddings=131072,
        weight_dtype="bf16", kv_dtype="fp16",
    ),
    "glm-z1": ModelSpec(
        name="GLM-Z1", family="GLM", architecture="moe",
        total_params_b=355, active_params_b=32, num_layers=61, hidden_size=7168,
        attention_type="gqa", max_position_embeddings=131072,
        weight_dtype="bf16", kv_dtype="fp16",
    ),
    "llama-3.1-405b": ModelSpec(
        name="Llama-3.1-405B", family="Llama", architecture="dense",
        total_params_b=405, active_params_b=405, num_layers=126, hidden_size=16384,
        num_attention_heads=128, num_kv_heads=8, attention_type="gqa",
        max_position_embeddings=131072, weight_dtype="bf16", kv_dtype="fp16",
    ),
    "minimax-m3": ModelSpec(
        name="MiniMax-M3", family="MiniMax", architecture="moe",
        total_params_b=245, active_params_b=10, num_layers=62, hidden_size=5120,
        attention_type="lightning", max_position_embeddings=1000000,
        weight_dtype="bf16", kv_dtype="fp16",
    ),
}
...
def resolve_spec(model_id: str, override: dict[str, Any] | None = None) -> ModelSpec | None:
    ...
    if base is None:
        ...
        if override and any(override.get(k) for k in ("active_params_b", "total_params_b", "weight_dtype")):
