...
def _analyze_concurrency(df, model_id):
    ...
    if tp_col:
        ...
        if peak_tp > 0:
            ...
            insights.append("❌ **Throughput Anomaly**: System throughput is 0. Please check test configuration and API response data.")
...
def _analyze_prefill(df, model_id):
    ...
    if max_speed > 0:
        ...
        insights.append("❌ **Prefill Speed Anomaly**: Prefill speed is 0 at all levels. Please check token counting and TTFT data.")
        return insights
