...
from core.result_metrics import calculate_success_rate_percent
from ui.charts import plot_performance_summary
from ui.reporting.columns import COLUMN_TOOLTIPS
...
def render_comparison_page():
    ...
    if (
        "system_output_throughput" not in combined_df.columns
        and "system_throughput" in combined_df.columns
    ):
        ...
        .agg(
            {
                ...
                "error": calculate_success_rate_percent,  # Success Rate
                "prefill_speed": "max",
            }
        )
        .reset_index()
                ...
                column_config={
                    **{
                    ...
                    "system_output_throughput": st.column_config.ProgressColumn(
                        ...
                        min_value=0,
                        max_value=(
                            combined_df["system_output_throughput"].max() * 1.1
                            if "system_output_throughput" in combined_df
                            else 100
                        ),
                    ),
                    "error": "Error",
