...
from engine.persistence.models import ExecLogModel, TestResultModel, TestRunModel, init_database
...
def test_save_results_batch(db_writer):
    ...
    results = [{"session_id": i, "ttft": 0.1 * i, "tps": 50.0 - i} for i in range(1, 6)]
