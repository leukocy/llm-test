...
def _ctx(**overrides):
    base = {
        ...
        "hardware_fingerprint": {
            ...
            "gpus": [{"name": "RTX PRO 6000", "vram_gb": 96, "nominal_bandwidth_gbps": 1792,
        ...
        "client_vs_engine": {"client_ttft_s": 0.7, "engine_ttft_s": 0.3,
                             "ttft_overhead_pct": 133.3, "verdict": "开销显著，延迟在引擎之外"},
        ...
        "gate": {"level": "internal", "gates": {"config_complete": True, "reproducible": True,
                                                "metrics_trustworthy": True, "external_reviewed": False},
                 "reasons": ["未经人工复核"]},
        "insights": ["🚀 良好", "⚠️ 偶发波动"],
        "notes": "8卡 TP",
