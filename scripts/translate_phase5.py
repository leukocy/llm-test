...
TRANSLATIONS = {
    ...
    "⏱️ Latency对比": "⏱️ Latency Comparison",
    ...
    "⚖️ AI 裁判succeeded修正 ": "⚖️ AI Judge successfully corrected ",
