...
def download_gpqa():
    ...
    print("\n" + "=" * 50)
    print("下载 GPQA Diamond (研究生级别科学推理)")
    print("=" * 50)
...
def download_longbench():
    ...
    print("\n" + "=" * 50)
    print("下载 LongBench (长onunder文理解)")
    print("=" * 50)
    ...
    try:
        ...
        print("正在从 HuggingFace 下载 (这可能need一些时间)...")
...
def download_swebench_lite():
    ...
    print("\n" + "=" * 50)
    print("下载 SWE-Bench Lite (软件工程问题)")
    print("=" * 50)
